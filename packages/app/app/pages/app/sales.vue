  ...
  <UDashboardPanel id="sales">
    ...
    <template #body>
      ...
      <template v-else>
        <UCard>
          <template #header>
            <h2 class="text-sm font-semibold">New {{ docType }} (sale)</h2>
          </template>
          <div class="space-y-2">
            <div class="grid grid-cols-1 gap-2 sm:grid-cols-3">
              <UInput v-model="docForm.partner" placeholder="Customer" />
              ...
              <table class="w-full min-w-[640px] text-sm">
                ...
                <tbody>
                  <tr v-for="(line, index) in lines" :key="index">
                    ...
                    <td class="py-1 pr-2"><UInput v-model="line.description" placeholder="Widget" /></td>
